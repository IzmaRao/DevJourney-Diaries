...
export default function Blog() {
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            try {
                const response = await fetch(`https://dev-journey-diaries.vercel.app/api/blog/`, { cache: 'no-cache'})
                if (!response.ok) {
  ...
  return (
    <div className='featuredblog space-y-8'>
        <h1 className='featuredblog-h'>All Blogs</h1>
            ...
            <div className="featuredblog-item space-y-3 bg-[#dfdfdf75] rounded" key={blog.id}>
                ...
                <div className='featuredblog-item-content space-y-3'>
                    ...
                    <div>
                        ...
                        <button className="featuredblog-item-btn bg-[#151515] text-white rounded">Read More</button>
                        </Link>
                    </div>
